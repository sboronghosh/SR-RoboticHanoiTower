...
def launch_setup(context, *args, **kwargs):
    ...
    # Use LOCAL fixed launch file with Zeroed Spawn Coordinates
    robot_gazebo_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('hanoi_tower'), 'launch', 'hanoi_robot_gazebo.launch.py'])),
        launch_arguments={
            'dof': dof,
            'robot_type': robot_type,
            'prefix': prefix,
